...
const API_BASE_URL = 'hhttps://legalease-navy.vercel.app/chatbot' // Adjust this to your FastAPI server URL
...
const LegalAssistantChat = () => {
  ...
  const startNewChat = async () => {
    try {
      const response = await axios.post("https://legalease-navy.vercel.app/chatbot/new_chat")
  ...
  const generateResponse = async () => {
    ...
    try {
      const response = await axios.post("https://legalease-navy.vercel.app/chatbot/process_query", {
        query: query,
      ...
      // Save chat history
      await axios.post("https://legalease-navy.vercel.app/chatbot/save_chat/${currentSessionId}", [
        ...chatHistory,
        newMessage,
        botResponse,
      ])
  ...
  const loadChatHistory = async (sessionId) => {
    try {
      const response = await axios.get("https://legalease-navy.vercel.app/chatbot/get_chat_history/${sessionId}")
